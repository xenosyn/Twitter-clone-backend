...
/**
 * A program to test the functionality of this social media app.
 * 
 * @author Hayden
 * @author Jorel
 * @version 1.0
...
public class SocialMediaPlatformTestApp {
	...
	public static void initialise(SocialMediaPlatform platform) {
		...
		try {
			...
			platform.commentPost("neil",postID,"why am I laughing");
			...
			platform.savePlatform("test_001.ser");
			...
			platform.loadPlatform("test_001.ser");
